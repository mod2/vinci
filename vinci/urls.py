...
vincipatterns = patterns(
    ...
    url(r'^(?P<notebook_slug>[^\/]+)/(?P<section>log|note|page|journal|list)/$',
        'notebook_section', name='notebook_section'),
    url(r'^(?P<notebook_slug>[^\/]+)/(?P<section>log|note|page|journal|list)/search/$',
    ...
    url(r'^(?P<notebook_slug>[^\/]+)/(?P<section>log|note|page|journal|list)/(?P<entry_slug>[^\/]+)/$',
        'entry_detail', name='entry'),
    url(r'^(?P<notebook_slug>[^\/]+)/(?P<section>log|note|page|journal|list)/(?P<entry_slug>[^\/]+)/(?P<revision_id>[^\/]+)/$',
